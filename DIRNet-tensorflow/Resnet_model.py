...
def imagenet_resnet_v2_generator(block_fn, layers, num_classes, use_as_loc,
                                 data_format=None):
...
params['block'], params['layers'], num_classes, data_format=data_format, use_as_loc=use_as_loc)